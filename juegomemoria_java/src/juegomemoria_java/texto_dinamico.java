...
public class texto_dinamico extends Thread {
    int contador;
    ...
    public texto_dinamico(JLabel lblCadena, JLabel lblMensaje)
    {
    ...
    public texto_dinamico(String cadena, int sleep, JLabel lblCadena, JLabel lblMensaje) throws Exception
    {
        try
        {
            this.cadena = cadena;
    ...
    public void run()
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                Logger.getLogger(texto_dinamico.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
}
